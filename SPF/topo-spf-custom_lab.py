...
class MyTopo(Topo):
    ...
    def __init__(self):
        ...
        h7 = self.addHost("h7", ip="10.4.0.7/8")
        h8 = self.addHost("h8", ip="10.4.0.8/8")
        ...
        # Switch 2
        self.addLink(s2, h3, port1=2, port2=1)
        self.addLink(s2, h4, port1=3, port2=1)

        # Switch 3
        self.addLink(s3, h5, port1=3, port2=1)
        self.addLink(s3, h6, port1=4, port2=1)

        # Switch 4
        self.addLink(s4, h7, port1=4, port2=1)
        self.addLink(s4, h8, port1=1, port2=1)
        ...
        self.addLink(s4, s1, port1=2, port2=4)
